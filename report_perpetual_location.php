...
<div class="container">
<center>
    <h2>Perpetual Times Calendar</h2>
    <h3>For The Year <?php echo date("Y"); ?></h3>

    <table class="table table-striped table-sm" style="width:40%">
		<tr>
			<th>Latitude</th>
			<td><h5><?php echo $LATITUDE; ?></h5></td>
		</tr>
		<tr>
			<th>Longitude</th>
			<td><h5><?php echo $LONGITUDE; ?></h5></td>
		</tr>
		<tr>
			<th>Time Zone</th>
			<td><h5><?php echo $TIMEZONE; ?></h5></td>
		</tr>
		<tr>
			<th>HASL</th>
			<td><h5><?php echo $HASL; ?></h5></td>
		</tr>
	</table>
