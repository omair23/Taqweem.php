    ...
    <div id="users">
        ...
        <tr><th>Name</th><th>Town</th><th>Country</th></tr>";
            ...
            while($row = $result->fetch_assoc()) {
				$id = $row["ID"];
                echo "<tr><td class=\"name\">" .$row["NAME"].
                    "</td><td class=\"town\">".$row["TOWN"].
                    "</td><td class=\"country\">".$row["COUNTRY"].
					"</td><td><a href='edit_masjid.php?ID=$id'>Edit Masjid</a>".
                    "</td><td><a href='upload_times.php?ID=" . $row["ID"]. "'>Upload Times</td></tr>";
            }
            echo "        </tbody>
    </table>";
        } else {
