...
else
{
  ...
  if ( $file = fopen( $storagename ,"r") ) {
      ...
      $DayNumber = 0;
      $isCalendar = false;
      $Query = "DELETE FROM MASJID_TIME WHERE MASJID_ID=" .$uid ;
      ...
      foreach ($dsatz as $key => $number) {
          ...
          foreach ($number as $k => $content) {
              ...
              if ($isCalendar == true){
                  ...
                  $DayNumber += 1;
                  if ($DayNumber <= 366){
                      $Query = "INSERT INTO MASJID_TIME VALUES('$uid', '$DayNumber', '$rowArray[10]', '$rowArray[11]','$rowArray[12]','$rowArray[13]','$rowArray[14]','$rowArray[15]','$rowArray[18]','$rowArray[19]')";
                      $result = $conn->query($Query);
                  }
              }
